...
if __name__ == '__main__':
    ...
    #dataset = PygLinkPropPredDataset(root="data",name=f'ogbl-collab')
    data = dataset[0]
    ...
    end_time = time.time()
    # 按照社区大小从大到小排序输出
    com = sorted(communities, key=lambda b: -len(b))  # 按社区大小排序
    count = 0
    '''
    for communitie in com:
        count += 1
